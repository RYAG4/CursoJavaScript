...
function menu (){
    ...
    switch (op){
        case "3":
            huir()
            $("pensamientos").innerHTML = `<p>Corri sin rumbo hasta morir de hambre</p>`

            //console.error ("Corriste sin rumbo hasta morir de hambre");
            break;
        case "2":
            $("pensamientos").innerHTML = `<p>No has echo nada por un rato... que aburrido</p>`
...
function juego (){
    $("pensamientos").innerHTML = `<p>Abri mis ojos lentamente por la luz</p>`
    $("dialogos").innerHTML = `<p>-Al fin despiertas ` + nombre + `!!</p>`
    ...
    if (accion == "si"){
        $("pensamientos").innerHTML = `<p>Intente moverme pero cai al intentar pararme</p>`
        ...
        do{
            ...
            if (respuesta == "90"){
                ...
                $("pensamientos").innerHTML = `<p>Me volvi a recostar en la cama y cerre mis ojos esparando por saber como llegue a este lugar</p><p>... Iniciando sistema ...</p><p>-Bienvenido ` + nombre + `</p><p>Despierte en una habitacion a solas, a mi alrededor solo puedo ver un espejo, un armario y un escritorio</p>`
...
function accion1 (){
    $("respuestas").innerHTML = `<p>Arrimarte al espejo</p><p>Arrimarte al armario</p><p>Arrimarte al escritorio</p><p>Quedarte en la cama</p><p>5: Salir de la habitacion</p>`
    ...
    switch (op){
        case "5":
            $("pensamientos").innerHTML = `<p>Sali de la habitacion</p>`
            ...
            if (salir == "si"){
                ...
                console.log(cerrar)
                $("pensamientos").innerHTML = `<p>Cerre con llave y sali hacia la escuela</p>`
        ...
        case "4":
            ...
            break;
        case "3":
            $("pensamientos").innerHTML = `<p>Me aserque al escritorio, en el puedo ver una computadora y una mochila con algunos utiles escolares</p>`
            ...
            if (agarrarMochila == "si"){
                $("pensamientos").innerHTML = `<p>Agarre la mochila</p>`
            ...
            break;
        case "2":
            $("pensamientos").innerHTML = `<p>Me aserque al armario</p>`

            //console.log ("Te asercas al armario");
            let eEg = prompt ("Quieres entrar en el?") .toLowerCase();
            if (eEg == "si"){
                $("pensamientos").innerHTML = `<h3>Ahora estas dentro del closet</h3>`

                //document.write ("<h3>Ahora estas dentro del closet</h3>");
                
                do{
                    eEg = prompt ("Quieres salir?") .toLowerCase();
                    //ERROR = NO SE COMO UNILIZAR EL .innerHTML EN ESTE LUGAR SIN DAÑAR LO QUE HICE
                    let closet = eEg == "si" ? "<h3>Has salido del closet</h3>":"<p>Tarde o temprano tendras que salir</p>"
            ...
            break;
        case "1":
            $("pensamientos").innerHTML = `<p>Me aserque al espejo</p><p>Veo algunas cosas a mi alrededor en el</p><h3>Edad ` + protagonista["edad"] + `</h3><h3>Valor ` + protagonista["valor"] + `</h3>`
